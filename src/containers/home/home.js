            ...
            <main>
                    ...
                    <div className="sec">
                        <section className="rounded-tl-lg flex-1">
                            ...
                            <div>
                                <p className="text-2xl font-bold text-black">Qualidade na construção</p>
                        ...
                        <section className="flex-1">
                            ...
                            <div>
                                <p className="text-2xl font-bold text-white">Excelentes profissionais</p>
                        ...
                        <div className="sectionimg p-2 bg-black rounded-full mr-4">
                            ...
                            <div>
                                <p className="text-2xl font-bold text-black">Dedicados para nossos clientes</p>
